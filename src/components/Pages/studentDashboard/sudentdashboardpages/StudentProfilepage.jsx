...
const StudentProfilePage = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (hidebioref.current && !hidebioref.current.contains(event.target)) {
        seteditbio(false);
      }
    };
    ...
    <>
      <div className=" mt-10 md:mt-20 md:mx-10 relative">
        ...
        {EditShow && (
          <div
            ref={hideref}
            className="flex w-96 flex-col gap-4 absolute border p-4 rounded-xl bg-white top-32 right-1/3 shadow-xl  dark:bg-gray-900  dark:text-white"
          >
        ...
        {editbio && (
          <div
            ref={hidebioref}
            className="flex w-96 flex-col gap-4 absolute border p-4 rounded-xl bg-white top-72 right-1/3 shadow-xl  dark:bg-gray-900 dark:text-white "
          >
            <div className="flex justify-between items-center">
