  ...
  return (
    <>
      <div className="w-full max-w-[1800px] m-auto bg-secondary dark:bg-gray-900 shadow-xl noselect ">
        <div className="w-full px-4 lg:px-12  py-2 md:py-4 lg:py-10 xl:py-16 md:flex items-center  justify-center md:gap-24 2xl:gap-80 text-white">
          <div className=" flex items-center gap-12 justify-center bg-white rounded-full px-6 py-4 md:py-2 text-black md:text-white md:bg-transparent">
            ...
            <div>
              <h1 className="text-2xl md:text-lg lg:text-3xl  font-semibold ">
                100+
              </h1>
