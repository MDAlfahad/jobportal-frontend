  ...
  return (
    <>
      <div className="mt-16 px-6 py-4 relative w-full h-[90vh]">
        {/* Popup */}
        {open && (
          <div className="p-8 border shadow-lg rounded-xl absolute bg-white dark:bg-gray-900  top-10 left-[25%] z-50">
            ...
            <form className="flex flex-col gap-2 w-full mt-4">
              ...
              <input
                className="px-2 py-2 border rounded-sm bg-gray-100 dark:bg-transparent dark:border-gray-500 outline-none"
                type="text"
              />
        ...
        <div className="overflow-y-auto px-4">
          <div className="flex justify-between items-center">
            <h1 className="text-xl md:text-3xl text-textcolor font-medium py-6 dark:text-white">
              Companies
            </h1>
              ...
              <tbody>
                {companyList.map((company) => {
                  ...
                  return (
                    <tr
                      key={company.user_id}
                      className="text-center text-sm dark:bg-gray-900"
                    >
